 ...
 */
final class Version20190531115938 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick CHANGE description description TEXT NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
